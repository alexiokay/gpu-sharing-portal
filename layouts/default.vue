script
<template lang="pug">
div(id="default" style="" class=" h-auto flex flex-col bg-[#FAF9FC] justify-center items-start w-full  font-righteous ")
    ...
    div(class=" w-full h-auto min-h-screen mt-[3rem] lg:mt-0 ")
      <slot class="" />
